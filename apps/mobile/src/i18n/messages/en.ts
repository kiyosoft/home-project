export const en = {
  ...
  "widget.todo.title": "To-do",
  "widget.todo.pick": "Pick a to-do list.",
  "widget.todo.loading": "Loading…",
  "widget.todo.open": "{count} open",
  "widget.todo.openOne": "1 open",
  "widget.todo.openWord": "open",
  "widget.todo.caughtUp": "All caught up",
  "widget.todo.nothingOpen": "Nothing open",
  "widget.todo.done": "{count} done",
  "widget.todo.add": "Add item",
  "widget.todo.addPlaceholder": "Add an item…",
  "widget.todo.complete": "Mark complete",
  "widget.todo.incomplete": "Mark incomplete",
  "widget.todo.delete": "Delete item",
  "widget.todo.hideCompleted": "Hide completed ({count})",
  "widget.todo.showCompleted": "Show completed ({count})",
  "widget.todo.due": "Due {date}",
