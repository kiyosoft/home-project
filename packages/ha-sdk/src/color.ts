...
/**
 * React Native parses the legacy comma form but not the CSS Color 4 space form,
 * so this is the one spelling both platforms accept.
 */
export function rgbaCss(rgb: Rgb, alpha = 1): string {
